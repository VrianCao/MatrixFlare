...
- [~] 用 `Playwright + pinned Element Web release` 建立真实浏览器 non-local gate，并把其 journey coverage / evidence sidecar 接入当前 `staging` attestation 链。
