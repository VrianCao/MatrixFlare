...
| `EVID-CS-004` | `MX-CS-003`,`MX-CS-005`,`MX-CS-012`,`MX-CS-016`,`MX-CS-018`,`MX-CS-020`,`MX-CS-021`,`MX-CS-022`,`MX-CS-023`,`MX-CS-025`,`MX-CS-027`,`MX-CS-028`,`MX-CS-029` | protocol/governance | stub-only/unsupported route guard report | CI + staging | per release candidate | stub-only/unsupported route guards 返回固定 disabled/unsupported wire behavior、无 truth write、无 feature-flag 漂移，且 discoverability 面不会与 stub truth 冲突 | `evidence/L1/EVID-CS-004/` | release lifetime | client protocol + architecture |
