...
| `EVID-CS-002` | `MX-CS-004`,`006`,`007`,`010`,`015` | protocol | `/sync` conformance report | staging | per release candidate | filter lifecycle、`include_leave`、lazy-load members、initial/incremental/limited/`full_state`/`use_state_after`、push rules 与 notification counts 全通过 | `evidence/L1/EVID-CS-002/` | release lifetime | client protocol |
