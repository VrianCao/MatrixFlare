...
| `MX-CS-014` | Client-Server | `v1.17` | E2EE transport: keys upload/query/claim, cross-signing, backup | `Required-Core` | `30` | `gateway-worker`,`UserDO`,R2 | `IF-CS-042`,`IF-CS-043`,`IF-CS-044`,`IF-CS-045`,`IF-CS-046`,`IF-CS-047`,`IF-INT-USER-004` | `DATA-USER-003`,`DATA-USER-004`,`DATA-USER-005`,`DATA-USER-011`,`DATA-R2-006` | `FLOW-CS-SYNC-LONGPOLL` | `TEST-CS-003` | `EVID-CS-003` | `L1-L3` | homeserver 只负责传输与存储边界。 |
