...
| --- | --- | --- | --- | --- | --- | --- |
| `FLOW-CS-DISCOVERY` | client discovery | `30` | client, `gateway-worker` | `GET /.well-known/matrix/client`, `GET /_matrix/client/versions`, `GET /_matrix/client/*/capabilities`, or `GET /_matrix/client/{r0,v1,v3}/login` | 返回 homeserver 元数据、capabilities 与当前真实支持的 login flow advertisement | 静态错误、discoverability truth 漂移或缓存回退 |
