...
test('TEST-ROOM-002 ci-integration validates the L1 room version 12 default and redaction behavior', async (context) => {
  ...
  const alice = await registerUser(harness, {
    usernamePrefix: 'room2-ci-alice',
    deviceId: 'ROOM2CIALICE',
  });
