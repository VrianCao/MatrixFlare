...
test('TEST-MEDIA-001 pre-release covers current auth media, legacy unauth compatibility, animated thumbnails, and pending-upload quota', async (context) => {
  ...
  const quotaUser = await registerUser(harness, {
    usernamePrefix: 'media-prerelease-quota',
    deviceId: 'MEDIAPRQUOTA',
  });
