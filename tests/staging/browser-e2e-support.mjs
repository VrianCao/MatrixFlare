...
// Staging E2E keeps its repo-owned dependency closure inside tests/staging.
// Keep this module semantically aligned with packages/testing/src/browser-e2e.mjs.
