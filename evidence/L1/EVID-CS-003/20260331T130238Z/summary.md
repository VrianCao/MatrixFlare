...
- expanded_source_ids: `MX-CS-013`, `MX-CS-014`
- applicable_source_ids: `MX-CS-013`, `MX-CS-014`
...
- Devices, to-device transport, and one-time key at-most-once behavior must pass in staging.
