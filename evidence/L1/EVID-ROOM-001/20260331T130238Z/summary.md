...
- expanded_source_ids: `MX-CS-008`, `MX-CS-009`, `MX-CS-010`
- applicable_source_ids: `MX-CS-008`, `MX-CS-009`, `MX-CS-010`
...
- Room creation, membership, event send, fanout, receipts, and typing must pass in CI integration and staging.
