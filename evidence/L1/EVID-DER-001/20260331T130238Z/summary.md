...
- expanded_source_ids: `MX-CS-017`, `MX-FED-006`
- applicable_source_ids: `MX-CS-017`
...
- For L1, search, user directory, public rooms, hierarchy, and rebuild consistency must pass in staging and pre-release, including publicRooms dispatch and deterministic rejection of unauthenticated POST.
