...
- expanded_source_ids: `MX-CS-011`, `MX-FED-008`
- applicable_source_ids: `MX-CS-011`
...
- For L1, local media upload/download/thumbnail, authenticated current surfaces, legacy unauthenticated freeze behavior, and animated-thumbnail cache isolation must pass in staging and pre-release.
