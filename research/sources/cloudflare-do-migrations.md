...
1. Add the following lines to your Wrangler configuration file:  
   * [  wrangler.jsonc ](#tab-panel-4712)  
   * [  wrangler.toml ](#tab-panel-4713)  
```  
{  
  "migrations": [  
    {  
...
* [  wrangler.jsonc ](#tab-panel-4714)
* [  wrangler.toml ](#tab-panel-4715)
...
3. Add the following lines to your Wrangler configuration file.  
   * [  wrangler.jsonc ](#tab-panel-4716)  
   * [  wrangler.toml ](#tab-panel-4717)  
```  
{  
  "migrations": [  
    {  
...
* [  wrangler.jsonc ](#tab-panel-4720)
* [  wrangler.toml ](#tab-panel-4721)
...
1. Edit your Wrangler configuration file in the following way:  
   * [  wrangler.jsonc ](#tab-panel-4726)  
   * [  wrangler.toml ](#tab-panel-4727)  
```  
{  
  "durable_objects": {  
    "bindings": [  
...
* [  wrangler.jsonc ](#tab-panel-4728)
* [  wrangler.toml ](#tab-panel-4729)
