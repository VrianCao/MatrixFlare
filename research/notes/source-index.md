...
* Matrix 事件签名与 event schema 相关 appendices；
* Matrix media repository 的边界细节；
* Matrix 对 room version 兼容矩阵的细化要求；
* Cloudflare observability / analytics / deployment versioning 文档；
* Cloudflare secrets / key management / access control 相关资料。
